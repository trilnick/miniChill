---
title: "Comparing Results with Excel Model"
...
Here I just want to verify the miniChill code with an example given in the Excel sheet model which I downloaded from the University of California Department of [Agriculture and Natural Resources](http://ucanr.edu/sites/fruittree/How-to_Guides/Dynamic_Model_-_Chill_Accumulation/). The Excel file is available in this package. I also transformed the main example into a csv file for easy comparison. It has relatively few temperature hours, and ends with just one chill portion accumulated. To compare the functions, I make sure that the chill portion calculation comes out the same for all the vector lengths.
...
Below is an R implementation of the chill portion calculator.
...
On my machine, the *R* based function is slower by 3 orders of magnitude.
